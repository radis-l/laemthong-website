...
-- Products (12)
-- ========================================
insert into products (slug, category_slug, brand_slug, name, short_description, description, image, gallery, specifications, features, documents, featured, sort_order) values
